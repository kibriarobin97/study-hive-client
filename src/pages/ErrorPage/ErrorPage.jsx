            ...
            <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
                <div className="wf-ull lg:w-1/2">
                    ...
                    <div className="flex items-center mt-6 gap-x-3">
                        <Link to='/'>
                            <button className="w-full btn btn-secondary px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 font-bold rounded-lg shrink-0 sm:w-auto ">
                                Take me Home
                            </button>
                        </Link>
                    </div>
